...
class MLflowManager:
    def __init__(self, config_path: str = "/usr/local/airflow/include/config/ml_config.yaml"):
        ...
        self.mlflow_available = self._test_mlflow_connection()
        ...
        if self.mlflow_available:
            ...
            logger.warning("MLflow not available, using local file tracking")
        ...
        self.client = MlflowClient(tracking_uri=self.tracking_uri) if self.mlflow_available else None
    ...
    def _test_mlflow_connection(self) -> bool:
        ...
        try:
            ...
            if parsed_uri.scheme in ['http', 'https']:
                ...
                # For file:// or other schemes, assume available
                return True
        except Exception as e:
